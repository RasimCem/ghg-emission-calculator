...
(function (exports, $) {
    ...
    class PDFjsViewer {
        ...
        /**
         * Function that removes the content of a page and replaces it with the empty content (images.e. a content generated by function emptyContent)
        ...
        */
        ...
        /**
         * Function that creates the pageinfo structure for one page, along with the skeleton to host the page (images.e. <div class="page"><div class="content-wrapper"></div></div>)
        ...
        _createSkeleton(page, i) {
            ...
            // Clean the page (images.e. put the empty content, etc.)
        ...
        /**
         * This function places the page.$div in the container, according to its page number (images.e. it searches for the previous page and puts this page after)
        ...
        scrollToPage(i) {
            ...
            if (position !== undefined) {
                this.$container.scrollTop(((parseFloat($page.css("height")) + parseFloat($page.css("margin-top"))) * (i - 1)))
                this.$container.scrollLeft(((parseFloat($page.css("width")) + parseFloat($page.css("margin-left"))) * (i - 1)))
            }
        ...
        /**
         * This functions forces the creation of the whole content of the viewer (images.e. new divs, structures, etc.). It is usefull for full refresh of the viewer (e.g. when changes
